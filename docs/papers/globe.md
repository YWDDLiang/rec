...
**证据深度：L0 primary arXiv abstract in search index only; direct page fetch failed。不是 L1 全文逐项完成，不是 L2 代码审计或 L3 独立复现。**

一手入口：[globe](https://arxiv.org/abs/2608.02690)；最后核验 2026-09-05。

## 来源支持的事实

检索到的一手arXiv摘要描述多checkpoint梯度轨迹和高阶匹配。

## 对本项目的直接约束

全文直接打开失败，仅作为新近碰撞线索；不能声称已完成全文审计。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `attribution` 问题簇。 |
