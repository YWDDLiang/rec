...
一手入口：[kuairand](https://kuairand.com/)；最后核验 2026-09-05。

## 来源支持的事实

含标准和随机曝光、多种反馈及场景字段；另有文本补充文件。

## 对本项目的直接约束

Pure 序列不完整；click 依 UI 有不同定义；随机标记不等于每个事件已知 propensity。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `dataset` 问题簇。 |
