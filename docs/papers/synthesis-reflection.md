# A critical reflection on attempts to machine-learn materials synthesis

**证据深度：L0 primary page/abstract/documentation inspected。不是 L1 全文逐项完成，不是 L2 代码审计或 L3 独立复现。**

一手入口：[synthesis-reflection](https://doi.org/10.1039/D4FD00112E)；最后核验 2026-09-05。
...
科学数据生成和报告选择过程必须与模型目标分开。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `science` 问题簇。 |
