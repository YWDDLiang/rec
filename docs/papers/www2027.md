# ACM Web Conference 2027 Research Track Papers

**证据深度：L0 primary page/abstract/documentation inspected。不是 L1 全文逐项完成，不是 L2 代码审计或 L3 独立复现。**

一手入口：[www2027](https://www2027.thewebconf.org/research-track-papers/)；最后核验 2026-09-05。
...
仅在网上获取的数据集上训练不自动满足领域相关性。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `venue` 问题簇。 |
