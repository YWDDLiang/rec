...
一手入口：[morec](https://arxiv.org/html/2310.13260v1)；最后核验 2026-09-05。

## 来源支持的事实

通过目标导向数据采样与控制机制协调推荐的多个目标。

## 对本项目的直接约束

数据视角的多目标推荐已有直接 WWW 基线。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `multiobjective` 问题簇。 |
