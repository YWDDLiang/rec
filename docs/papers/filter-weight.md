...
一手入口：[filter-weight](https://arxiv.org/html/2604.00001v2)；最后核验 2026-09-05。

## 来源支持的事实

按当前优化器状态构造目标导向更新，并解耦过滤与权重优化。

## 对本项目的直接约束

更新导向、优化器感知、样本交互都已有工作，不能作为独占 claim。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `selection` 问题簇。 |
