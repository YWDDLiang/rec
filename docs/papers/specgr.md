...
一手入口：[specgr](https://arxiv.org/html/2410.02939v1)；最后核验 2026-09-05。

## 来源支持的事实

用具有归纳能力的候选提议器与生成式验证器支持新物品。

## 对本项目的直接约束

draft-verify 还可能改善冷启动；并非仅计算加速的空白。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `decoding` 问题簇。 |
