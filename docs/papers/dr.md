...
一手入口：[dr](https://arxiv.org/html/1103.4601v2)；最后核验 2026-09-05。

## 来源支持的事实

结合奖励模型与日志策略信息进行 contextual-bandit 评估。

## 对本项目的直接约束

双重稳健不消除 positivity/MAR 要求，不自动解决长序列 OPE。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `evaluation` 问题簇。 |
