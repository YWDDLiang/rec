...
一手入口：[genrec](https://arxiv.org/html/2608.10257)；最后核验 2026-09-05。

## 来源支持的事实

语言模型主干接目录感知的排序输出，采用奖励加权训练。

## 对本项目的直接约束

不能把文中讨论的 RL 潜力写成本文已经部署 GRPO；也不是本项目自己的线上证据。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `LLM4Rec` 问题簇。 |
