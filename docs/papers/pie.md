...
一手入口：[pie](https://arxiv.org/html/2304.06844v1)；最后核验 2026-09-05。

## 来源支持的事实

PIE 结合个性化图搜索、新创作者发现与在线探索机制。

## 对本项目的直接约束

PageRank 加 bandit 进行兴趣探索已经出现，不能作为新颖性的主张。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `exploration` 问题簇。 |
