...
一手入口：[greats](https://proceedings.neurips.cc/paper_files/paper/2024/hash/ed165f2ff227cf36c7e3ef88957dadd9-Abstract-Conference.html)；最后核验 2026-09-05。

## 来源支持的事实

通过Taylor近似与greedy进行每轮在线batch选择。

## 对本项目的直接约束

数据交互、二阶Taylor批次选择已有工作，不能作为新颖性的全部依据。
