...
**证据深度：L0+ selected HTML methods inspected; not full reproduction。不是 L1 全文逐项完成，不是 L2 代码审计或 L3 独立复现。**

一手入口：[rise](https://arxiv.org/html/2604.16197v2)；最后核验 2026-09-05。

## 来源支持的事实

RISE 从 readout 的词汇残差和语义误差信号构造归因近似。

## 对本项目的直接约束

PPT 中 PPO rollout 过滤内容不能直接归于此论文；原文全文未检出 PPO。
