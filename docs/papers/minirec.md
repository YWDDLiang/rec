...
一手入口：[minirec](https://arxiv.org/html/2602.04278v1)；最后核验 2026-09-05。

## 来源支持的事实

RL 选样结合可学习性、梯度代表性、多样性与课程。

## 对本项目的直接约束

单纯从 SFT 迁移到 RL，或奖励加梯度加去重，会直接碰撞。

## 十二项审计中的当前覆盖与缺口

| 项目 | 本轮状态 |
|---|---|
| Scientific problem | 已按来源摘要和问题定义进行定位，属于 `RL` 问题簇。 |
